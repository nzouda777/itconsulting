    ...
    <div className="min-h-screen font-sans">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-tr from-second via-transparent to-transparent">
        ...
        <div className="absolute inset-0">
          {[...Array(15)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-2 h-2 bg-prime/20 rounded-full"
              style={{
        ...
        <motion.div style={{ y, opacity }} className="2xl:container  max-w-[100%] mx-auto overflow-x-hidden px-6 md:px-12  mx-auto px-6 relative z-10">
          ...
          >
            ...
            <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl font-bold mb-8 tracking-tight lg:w-8/12 mx-auto">
              {/* <span className="gradient-text">{t("HomePage.hero.title")}</span>
              <br /> */}
              <span className="text-slate-900 ">{t("HomePage.hero.title")}</span>
            </motion.h1>
      ...
      <section className="py-24 bg-white">
        <div className="2xl:container  max-w-[100%] mx-auto h-full overflow-x-hidden px-6 md:px-12  ">
          ...
          >
            <Badge className="mb-6 bg-slate-50 text-slate-700 border-slate-950 font-light md:text-sm text-xs hover:bg-slate-950 hover:text-white"> {t("HomePage.services.badge")} </Badge>
            <h2 className="text-5xl md:text-6xl font-bold mb-8 gradient-text"> {t("HomePage.services.title")}</h2>
                ...
                <div className="relative w-full h-full transition-transform duration-700 transform-style-preserve-3d group-hover:rotate-y-180 px-4">
                  ...
                  >
                    <CardContent className="p-8 flex flex-col justify-center items-center text-center h-full">
                      ...
                      <h3 className="md:text-2xl text-xl font-bold mb-4 text-slate-900">{ t(`HomePage.services.serviceItems.${service.key}.title`) }</h3>
                    ...
                    <CardContent className="p-2 md:p-8 h-full flex flex-col justify-between bg-white w-full  text-center">
                      <div className="space-y-2">
                        <div className="flex items-center mb-1 md:flex-row flex-col justify-center space-y-4">
                          ...
                          <h3 className="md:text-xl text-base font-bold text-slate-900 whitespace-wrap text-wrap w-full">{ t(`HomePage.services.serviceItems.${service.key}.title`) }</h3>
                        </div>

                        <div className="space-y-2 mb-3">

                      <p className="text-slate-600 leading-relaxed md:text-base text-xs">{ t(`HomePage.services.serviceItems.${service.key}.description`) }</p>
                      ...
                      <Link href={`/services#${service.key}`} className="w-full">
                        <Button className="w-full bg-second text-white font-medium hover:bg-gradient-to-r from-prime to-second duration-500 hover:bg-prime hover:duration-1000 transition-colors md:text-base text-xs md:py-2 py-1 md:h-10 h-8">
                          { t(`HomePage.services.serviceItems.${service.key}.cta`) }
      ...
      <section className="py-20 bg-slate-50">
        <div className="2xl:container  max-w-[100%] mx-auto overflow-hidden px-6 py-6 md:px-12 ">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-8 gradient-text"> { t("HomePage.featureSection.title") } </h2>
            <p className="text-md md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            { t("HomePage.featureSection.description") }
            </p>
          </motion.div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "lg:col-start-2" : ""}>
                  ...
                  <h3 className="text-3xl font-bold text-slate-900 mb-6">{t(`HomePage.featureSection.${feature.key}.title`)}</h3>
                  <p className="text-lg text-slate-600 leading-relaxed mb-8">{t(`HomePage.featureSection.${feature.key}.description`)}</p>
                  ...
                  <Link href="/services">
                    <Button className="bg-slate-900 hover:bg-slate-800 font-medium">
                      { t(`HomePage.featureSection.${feature.key}.cta`) }
                      <ArrowRight className="ml-2 w-4 h-4" />
                    </Button>
                  </Link>
                </div>
