...
import { Facebook, Instagram, Youtube, Phone, Linkedin} from 'lucide-react'

export default function Announcement() {
    return (
        <div className='text-white bg-gradient-to-r from-prime to-second'>
            <div className="2xl:container max-w-[100%] mx-auto overflow-x-hidden px-6 md:px-12   py-2 flex text-xs md:text-md  items-center justify-between ">
